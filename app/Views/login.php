...
<html lang="en">
	...
	<head><base href="<?php echo base_url('template')?>">
		<meta charset="utf-8" />
		<title><?php echo lang('app.title_page_login');?> | <?php echo $settings['meta_title']?></title>
			...
			<div class="login login-3 wizard d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="login-aside d-flex flex-column flex-row-auto">
					...
					<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
						...
						<!--end::Aside header-->
						<!--begin::Aside Title-->
						<!--h3 class="font-weight-bolder text-center font-size-h4 text-dark-50 line-height-xl"><?php echo lang('app.slogan')?></h3-->
						<!--end::Aside Title-->
					</div>
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
					...
					<div class="d-flex flex-row-fluid flex-center">
						...
						<div class="login-form">
							<!--begin::Form-->
							 ...
							 <?php $attributes = ['class' => '', 'id' => 'kt_login_singin_form','method'=>'post'];
					echo form_open( base_url('Ajax/submit_signin_form'), $attributes);?>
								<!--begin::Title-->
								<div class="pb-5 pb-lg-15">
									<h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg"><?php echo lang('app.title_page_login');?></h3>
									<div class="text-muted font-weight-bold font-size-h4"><?php echo lang('app.sub_title_login');?>
									<a href="<?php echo base_url('/signup')?>" class="text-primary font-weight-bolder"><?php echo lang('app.sub_title_register')?></a></div>
								</div>
								<!--begin::Title-->
								<!--begin::Form group-->
								<div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark"><?php echo lang('app.field_your_email');?></label>
									<?php 
										$input = [
												'type'  => 'text',
												'name'  => 'email',
								...
								<div class="form-group">
									<div class="d-flex justify-content-between mt-n5">
										<label class="font-size-h6 font-weight-bolder text-dark pt-5"><?php echo lang('app.field_your_password');?></label>
										<a href="<?php echo base_url('/forgot')?>" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5"><?php echo lang('app.sub_title_forgot_password');?></a>
									</div>
									<?php 
										$input = [
												'type'  => 'password',
								...
								echo form_button($data,lang('app.btn_login'));?>
		    ...
		    .on('core.form.valid', function() {
				...
				$("#error_alert").hide(0);
					...
					if (response && typeof response === 'object' &&  response.error == false) {
						Swal.fire({
			                text: "<?php echo lang('app.success_form_login')?>",
			                icon: "success",
			                buttonsStyling: false,
							confirmButtonText: "<?php echo lang('app.btn_dashboard')?>",
							customClass: {
						...
						Swal.fire({
			                text: "<?php echo lang('app.error_form_login')?>",
			                icon: "error",
			                buttonsStyling: false,
