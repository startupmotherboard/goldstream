											...
											<div class="card-body pt-4">
												...
												<div class="d-flex align-items-center">
													...
													<div>
														...
														<div class="mt-2">
															<a href="<?php echo base_url('customer/messages')?>" class="btn btn-sm btn-primary font-weight-bold mr-2 py-2 px-3 px-xxl-5 my-1"><?php echo lang('app.menu_messages')?></a>
												...
												<div class="navi navi-bold navi-hover navi-active navi-link-rounded">
													...
													<div class="navi-item mb-2">
														<a href="<?php echo base_url('customer/profile')?>" class="navi-link py-4 <?php if($menu_profile=='info') echo 'active'?>">
													...
													<div class="navi-item mb-2">
														<a href="<?php echo base_url('customer/profile/account')?>" class="navi-link py-4 <?php if($menu_profile=='account') echo 'active'?>">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
																	<!--begin::Svg Icon | path:<?php echo base_url('template')?>/assets/media/svg/icons/Communication/Shield-user.svg-->
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
