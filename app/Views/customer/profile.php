						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="d-flex flex-row">
									<!--begin::Aside-->
									<?php echo view('customer/includes/profile_aside.php',array('menu_profile'=>'info'));?>
									<!--begin::Content-->
									<div class="flex-row-fluid ml-lg-8">
										...
										<div class="card card-custom">
											...
											<!--begin::Form-->
											 <?php $attributes = ['class' => '', 'id' => 'profile_form','method'=>'post', 'novalidate'=>"novalidate"];
												echo form_open_multipart( base_url('customer/profile'), $attributes);
												$input = [
												'type'  => 'hidden',
												'name'  => 'action',
												'id'    => 'action',
										...
										echo form_input($input);
												...
												<?php if(isset($error)){?>
												<div class="row">
									<div class="alert alert-danger m-t-20" role="alert" id="" ><?php echo $error?></div>
												</div><?php } ?>
												<div class="row">
