						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="d-flex flex-row">
									<!--begin::Aside-->
									<?php echo view('admin/includes/profile_aside.php',array('menu_profile'=>'account'));?>
									<!--begin::Content-->
									<div class="flex-row-fluid ml-lg-8">
										...
										<div class="card card-custom">
											...
											<!--begin::Form-->
											 <?php $attributes = ['class' => '', 'id' => 'profile_form','method'=>'post', 'novalidate'=>"novalidate"];
												echo form_open_multipart( base_url('admin/profile/account'), $attributes);
												$input = [
												'type'  => 'hidden',
												'name'  => 'action',
												'id'    => 'action',
										...
										echo form_input($input);
												...
												<?php }?>
													...
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label"><?php echo lang('app.field_password');?></label>
														<div class="col-lg-9 col-xl-6">
															<?php 
															$input = [
																	'type'  => 'password',
