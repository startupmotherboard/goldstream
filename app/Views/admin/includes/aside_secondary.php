							...
							<div class="tab-content">
								...
								<img alt="Logo" src="<?php echo base_url('uploads/'.$settings['logo'])?>" class="max-h-30px" />
									...
									<div class="list list-hover mt-20">
										<!--begin::Item-->
										<a href="<?php echo base_url('admin/dashboard')?>" class="text-muted text-hover-primary font-weight-bold">
										...
										<!--begin::Item-->
										<a href="<?php echo base_url('admin/messages')?>" class="text-muted text-hover-primary font-weight-bold">
										...
										<!--begin::Item-->
										<a href="<?php echo base_url('admin/profile')?>" class="text-muted text-hover-primary font-weight-bold">
										...
										<!--begin::Item-->
										<a href="<?php echo base_url('logout')?>" class="text-muted text-hover-primary font-weight-bold">
