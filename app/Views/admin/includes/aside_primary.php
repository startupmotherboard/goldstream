...
<?php /*
					<div class="aside-primary d-flex flex-column align-items-center flex-row-auto">
						...
						<div class="aside-nav d-flex flex-column align-items-center flex-column-fluid py-5 scroll scroll-pull">
							...
							<ul class="nav flex-column" role="tablist">
								...
								<li class="nav-item mb-3" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="<?php echo lang('app.menu_dashboard')?>">
									<a href="<?php echo base_url('admin/dashboard')?>" class="nav-link btn btn-icon btn-clean btn-lg <?php if($menu=='dashboard') echo 'active'?>" >
								...
								<li class="nav-item mb-3" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="<?php echo lang('app.menu_chat')?>">
									<a href="<?php echo base_url('admin/messages')?>" class="nav-link btn btn-icon btn-clean btn-lg <?php if($menu=='chat') echo 'active'?>">
						...
						<div class="aside-footer d-flex flex-column align-items-center flex-column-auto py-4 py-lg-10">
							<!--begin::Aside Toggle-->
							<!--span class="aside-toggle btn btn-icon btn-primary btn-hover-primary shadow-sm" id="" data-toggle="tooltip" data-placement="right"  title="Toggle Aside">
							...
							<!--begin::User-->
							<a href="<?php echo base_url('admin/profile')?>" class="btn btn-icon btn-clean btn-lg w-40px h-40px <?php if($menu=='profile') echo 'active'?>" id="" data-toggle="tooltip" data-placement="right"  title="<?php echo lang('app.menu_profile')?>">
