											...
											<div class="card-body pt-4">
												...
												<div class="navi navi-bold navi-hover navi-active navi-link-rounded">
													...
													<div class="navi-item mb-2">
														<a href="<?php echo base_url('admin/clients/'.$inf_user['id'])?>" class="navi-link py-4 <?php if($menu_profile=='info') echo 'active'?>">
													...
													<div class="navi-item mb-2">
														<a href="<?php echo base_url('admin/clients/'.$inf_user['id'].'/home')?>" class="navi-link py-4 <?php if($menu_profile=='home') echo 'active'?>">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
															...
															<span class="navi-text font-size-lg"><?php echo lang('app.menu_client_home');?></span>
														</a>
													</div>
