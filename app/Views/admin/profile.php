		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left d-flex aside-fixed" id="kt_aside">
						<?php echo view('admin/includes/aside_primary.php',array('menu'=>'profile'));?>
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h2 class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3"><?php echo lang('app.title_page_profile_personel_info')?></h2>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
											...
											<li class="breadcrumb-item">
												<a href="<?php echo base_url('admin/profile')?>" class="text-muted"><?php echo lang('app.menu_profile');?></a>
											</li>
											
											<li class="breadcrumb-item">
												<a href="#" class="text-muted"><?php echo lang('app.menu_profile_perso');?></a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="d-flex flex-row">
									<!--begin::Aside-->
									<?php echo view('admin/includes/profile_aside.php',array('menu_profile'=>'info'));?>
									<!--begin::Content-->
									<div class="flex-row-fluid ml-lg-8">
										...
										<div class="card card-custom">
											...
											<div class="card-header py-3">
												<div class="card-title align-items-start flex-column">
													<h3 class="card-label font-weight-bolder text-dark"><?php echo lang('app.menu_profile_perso');?></h3>
													<span class="text-muted font-weight-bold font-size-sm mt-1"><?php echo lang('app.sub_title_profil_perso_info');?></span>
												</div>
												<div class="card-toolbar">
													<button type="button" class="btn btn-success mr-2 save_profile_btn" id=""><?php echo lang('app.btn_save')?></button>
													<a href="<?php echo base_url('admin/profile')?>" class="btn btn-secondary"><?php echo lang('app.btn_cancel')?></a>
												</div>
											</div>
											<!--end::Header-->
											<!--begin::Form-->
										...
										echo form_input($input);
												...
												<div class="row">
													...
													<div class="row">
														...
														<div class="col-lg-9 col-xl-6">
															<h5 class="font-weight-bold mb-6"><?php echo lang('app.sub_title_customer_info')?></h5>
														</div>
													</div>
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label"><?php echo lang('app.field_avatar');?></label>
														<div class="col-lg-9 col-xl-6">
															<div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url(assets/media/users/blank.png)">
																<div class="image-input-wrapper" style="background-image: <?php if($inf_profile['image']!=""){?>url(<?php echo base_url('uploads/customers/'.$inf_profile['image'])?>)<?php } else echo 'none'?>"></div>
																...
																<span class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" onclick="$('#profile_avatar_remove').val('1');" data-action="cancel" data-toggle="tooltip" title="Cancel avatar">
													...
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label"><?php echo lang('app.field_first_name');?></label>
														<div class="col-lg-9 col-xl-6">
														<?php 
															$input = [
																	'type'  => 'text',
													...
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label"><?php echo lang('app.field_last_name');?></label>
														<div class="col-lg-9 col-xl-6">
															<?php 
															$input = [
																	'type'  => 'text',
													...
													<div class="row">
														<label class="col-xl-3"></label>
														<div class="col-lg-9 col-xl-6">
															<h5 class="font-weight-bold mt-10 mb-6"><?php echo lang('app.sub_title_contact_info')?></h5>
														</div>
													</div>
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label"><?php echo lang('app.field_phone');?></label>
														<div class="col-lg-9 col-xl-6">
													...
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label"><?php echo lang('app.field_email');?></label>
														<div class="col-lg-9 col-xl-6">
															<div class="input-group input-group-lg input-group-solid">
																<div class="input-group-prepend">
																	<span class="input-group-text">
													...
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label"><?php echo lang('app.field_adr1');?></label>
														<div class="col-lg-9 col-xl-6">
															<?php 
															$input = [
																	'type'  => 'text',
													...
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label"><?php echo lang('app.field_adr2');?></label>
														<div class="col-lg-9 col-xl-6">
															<?php 
															$input = [
																	'type'  => 'text',
													...
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label"><?php echo lang('app.field_city');?></label>
														<div class="col-lg-9 col-xl-6">
															<?php 
															$input = [
																	'type'  => 'text',
													...
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label"><?php echo lang('app.field_zip');?></label>
														<div class="col-lg-9 col-xl-6">
															<?php 
															$input = [
																	'type'  => 'text',
													...
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label"><?php echo lang('app.field_province');?></label>
														<div class="col-lg-9 col-xl-6">
															<?php 
															$input = [
																	'type'  => 'text',
													...
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label"><?php echo lang('app.field_birthdate');?></label>
														<div class="col-lg-9 col-xl-6">
															<?php 
															$input = [
																	'type'  => 'text',
												...
												<div class="card-toolbar">
													<button type="button" class="btn btn-success mr-2 save_profile_btn" ><?php echo lang('app.btn_save')?></button>
													<a href="<?php echo base_url('admin/profile')?>" class="btn btn-secondary"><?php echo lang('app.btn_cancel')?></a>
												</div>
											</div>
											</form>
