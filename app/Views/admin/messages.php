	...
	<body id="kt_body" class="header-mobile-fixed aside-enabled aside-fixed aside-secondary-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left d-flex aside-fixed" id="kt_aside">
						<?php echo view('admin/includes/aside_primary.php',array('menu'=>'messages'));?>
								...
								<div class="d-flex align-items-center mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
											...
											<li class="breadcrumb-item">
												<a href="<?php echo base_url('admin/messages')?>" class="text-muted"><?php echo lang('app.menu_messages');?></a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="d-flex flex-row">
												...
												<div class="mt-7 scroll scroll-pull">
													...
													<div class="d-flex align-items-center justify-content-between mb-5">
														<div class="d-flex align-items-center">
															...
															<?php if($vv['inf_user']['image']!=''){?>
																<img alt="Pic" src="<?php echo base_url('uploads/customers/'.$vv['inf_user']['image'])?>" />
															<?php } else{
																?>
																<span class="font-size-h3 symbol-label font-weight-boldest"><?php echo strtoupper(substr($vv['inf_user']['first_name'],0,1).substr($vv['inf_user']['last_name'],0,1))?></span>
															<?php }?>
															</div>
															<div class="d-flex flex-column">
																<a onclick="get_messages('<?php echo $kk?>')" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg"><?php echo $vv['inf_user']['first_name'].' '.$vv['inf_user']['last_name']?></a>
																<span class="text-muted font-weight-bold font-size-sm">Client</span>
															</div>
														</div>
														<div class="d-flex flex-column align-items-end">
															<span class="text-muted font-weight-bold font-size-sm"><?php if($vv['last']!="") echo date('d M - H:i',strtotime($vv['last'])); else echo '--';?></span>
															<?php if($vv['unreaded']>0){?><span class="label label-sm label-success"><?php echo $vv['unreaded']?></span><?php } ?>
														</div>
													</div>
													<!--end:User-->
													<?php } ?>
									...
									<!--end::Aside-->
									<!--begin::Content-->
									<div class="flex-row-fluid ml-lg-8 bloc_messages" id="kt_chat_content">
		...
		<script>
			 function get_messages(user_id){
				$.ajax({
						  url:"<?php echo base_url('Ajax/get_messages_by_admin')?>",
						  method:"POST",
						  data:{user_id:user_id}
						  
					}).done(function(data){
						console.log(data);
						$(".bloc_messages").html(data);
					});
			}
